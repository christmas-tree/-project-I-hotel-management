...
public class ChiTietDatPhongDAO {
    ...
    public boolean create(ChiTietDatPhong chiTietDatPhong) {
        ...
        String sql = "INSERT INTO chi_tiet_dat_phong(ma_dat_phong, ma_phong, thanh_tien) " +
                "VALUES (?, ?, ?)";
        ...
        try {
            ...
            stmt.setLong(3, chiTietDatPhong.getThanhTien());
    ...
    public ObservableList<ChiTietDatPhong> getAll(DatPhong datPhong, ArrayList<Phong> dsPhong) {
        ...
        String sql = "SELECT ma_phong, thanh_tien FROM chi_tiet_dat_phong WHERE ma_dat_phong=?";
    ...
    public ArrayList<ChiTietDatPhong> getAllActive(ArrayList<Phong> dsPhong) {
        ...
        String sql = "SELECT ma_phong, thanh_tien FROM chi_tiet_dat_phong ct, dat_phong dp " +
    ...
    public boolean update(ObservableList<ChiTietDatPhong> dsChiTietDatPhong) {
        ...
        try {
            ...
            for (int i = 0; i < dsChiTietDatPhong.size(); i++) {
                ...
                stmt.setInt(1, chiTietDatPhong.getPhong().getMaPhong());
                stmt.setLong(2, chiTietDatPhong.getThanhTien());
                stmt.setInt(3, chiTietDatPhong.getDatPhong().getMaDatPhong());
                stmt.setInt(4, chiTietDatPhong.getPhong().getMaPhong());
